...
int track;
//int limitlogs=0;
const int BUFFERSIZE=2048; // to do: figure out a way to link up this const and the BUFFERSIZE const in javascript, so changing one changes the other. idea: change this to a define? which is better?
