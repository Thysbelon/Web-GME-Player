...
[ "_main", "_memory", "___indirect_function_table", "_endEmscripten", "_generatePCMfileAndReturnInfo", "_fflush", "__ZN6__asan9FakeStack17AddrIsInFakeStackEm", "__ZN6__asan9FakeStack8AllocateEmmm", "onRuntimeInitialized" ].forEach(prop => {
...
wasmBinaryFile = "Web-GME-Player-2.wasm";
...
var wasmSourceMapFile = "Web-GME-Player-2.wasm.map";
...
var _endEmscripten = Module["_endEmscripten"] = createExportWrapper("endEmscripten");

var _generatePCMfileAndReturnInfo = Module["_generatePCMfileAndReturnInfo"] = createExportWrapper("generatePCMfileAndReturnInfo");
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = createGMEmodule;
else if (typeof define === 'function' && define['amd'])
  define([], () => createGMEmodule);
